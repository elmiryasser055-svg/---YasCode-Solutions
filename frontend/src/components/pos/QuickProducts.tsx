      ...
      <AnimatePresence mode="wait">
        {products.length === 0 ? (
          ...
          >
            ...
            <p className="text-sm">{t("quickProducts.emptyCategory")}</p>
          </motion.div>
        ) : viewMode === "grid" ? (
          <motion.div
            key="grid"
              ...
              >
                <div className="flex w-full items-start justify-between">
                  <span className="inline-flex items-center rounded-md bg-[var(--bg-hover)] px-1.5 py-0.5 text-[10px] font-bold text-[var(--text-muted)]">
                    {product.unitType === "weight" ? t("pos.weight") : t("pos.piece")}
                  </span>
              ...
              >
                <div className="min-w-0 flex-1 text-right">
                  ...
                  <p className="text-xs text-[var(--text-muted)]">
                    {product.unitType === "weight" ? t("quickProducts.byWeight") : t("quickProducts.byPiece")}
                  </p>
                </div>
