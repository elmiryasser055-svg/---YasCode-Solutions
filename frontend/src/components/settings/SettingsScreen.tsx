...
export function SettingsScreen() {
  ...
  async function handleSave() {
    ...
    changeLanguage(language); // تطبيق فوري على الواجهة الحالية
    settings.refetch();
  }
    ...
    <div className="mx-auto flex h-full max-w-2xl flex-col p-6">
      ...
      >
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-2xl font-bold text-[var(--text-primary)]">إعدادات التطبيق</h1>
        </div>
        <p className="text-sm text-[var(--text-secondary)]">قم بضبط إعدادات المتجر، الطابعة، واللغة الافتراضية.</p>
      </motion.div>
      ...
      <div className="flex-1 space-y-6">
        ...
        <motion.div 
          ...
          className="yc-card"
        >
          <h3 className="text-sm font-medium text-[var(--text-secondary)] mb-4">التفضيلات العامة</h3>
          
          <label className="block mb-4">
            <span className="text-[var(--text-primary)] text-sm mb-2 block">اللغة الافتراضية</span>
          ...
          <label className="block">
            <span className="text-[var(--text-primary)] text-sm mb-1.5 block">عدد أيام تنبيه "قرب انتهاء الصلاحية"</span>
        ...
        <motion.div 
          ...
          className="yc-card"
        >
          <h3 className="text-sm font-medium text-[var(--text-secondary)] mb-4">إعدادات الطباعة</h3>
          
          <label className="block">
            <span className="text-[var(--text-primary)] text-sm mb-1.5 block">اسم الطابعة الحرارية</span>
            <div className="relative">
              <span className="absolute inset-y-0 left-3 flex items-center pointer-events-none text-[var(--text-muted)]">
              ...
              <input
                ...
                placeholder="مثال: XP-58 (اتركه فارغاً للطابعة الافتراضية)"
                data-barcode-ignore="true"
              />
            </div>
          </label>
